...
Stop-Transcript
if ($null -ne $email){
    Send-MailMessage -To $email -From "" -Subject "VMware-Tools-Mount-Report-$Date" -Attachments "$ReportExport\VMware-Tools-Mount-Report-$Date.txt" -SmtpServer '' -Port 25 -WarningAction Ignore
}
